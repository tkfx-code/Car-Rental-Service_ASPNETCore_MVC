...
namespace MVC_Project.Data.Migrations
{
    ...
    [Migration("20250612165948_changed classes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVC_Project.Models.BookingViewModel", b =>
                {
                    b.Property<int>("BookingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_Project.Models.CarListingViewModel", b =>
                {
                    b.Property<int>("CarId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CarListingCarId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CarListingCarId");

                    b.ToTable("CarListingViewModel");
                });
            ...
            modelBuilder.Entity("MVC_Project.Models.BookingViewModel", b =>
                {
                    b.HasOne("MVC_Project.Model.Booking", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("MVC_Project.Models.CarListingViewModel", b =>
                {
                    b.HasOne("MVC_Project.Model.CarListing", null)
                        .WithMany("CarListings")
                        .HasForeignKey("CarListingCarId");
                });
